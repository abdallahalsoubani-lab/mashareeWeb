    ...
    <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="group relative animate-slide-in-right" style={{ animationDelay: '0.3s' }}>
          ...
          <div className="relative bg-background-secondary rounded-2xl overflow-hidden border-2 border-primary/70 group-hover:border-primary transition-all duration-300 shadow-card group-hover:shadow-card-hover">
